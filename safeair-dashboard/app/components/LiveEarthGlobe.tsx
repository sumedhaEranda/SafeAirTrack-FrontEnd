...
export function LiveEarthGlobe() {
    ...
    <div className="rounded-3xl border border-slate-800 bg-slate-900/60 overflow-hidden shadow-[0_18px_45px_rgba(15,23,42,0.7)]">
      <div className="p-4 border-b border-slate-800">
        <div className="flex items-center justify-between">
          <div>
            <h2 className="text-sm font-medium text-slate-100">Live 3D Earth Globe</h2>
            <p className="text-xs text-slate-400">
              Real-time device locations - Auto-refreshes every 3 seconds
            </p>
          </div>
      ...
      <div className="p-3 border-t border-slate-800 bg-slate-950/40">
        <div className="flex flex-wrap items-center justify-between gap-4 text-[11px] text-slate-400">
          ...
          <div className="text-slate-500">
            {devicesWithLocations.length} device{devicesWithLocations.length !== 1 ? "s" : ""} • 
